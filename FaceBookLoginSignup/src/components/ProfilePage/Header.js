...
import styles from '../styles/facebookpage/header.module.css'

const Header = () => {
  return (
    <div className={[styles['header-container']]}>
       <div className={[styles['container'], "container-fluid"].join(" ")}>
        <div  className={[styles['rows'], "row"].join(" ")} >
            <div className={[styles['header-logo'], "col-md-2"].join(" ")}>
                <svg aria-label="Facebook logo" class="aghiwhmy" role="img" viewBox="0 0 120 24" width="120" fill="#1877F2">
            ...
            <div className={[styles['header-input'], "col-md-7"].join(" ")}>
              <input type="text" placeholder='Search Facebook'/>
            </div>
            <div className={[styles['header-img'], "col-md-3"].join(" ")}>
            {/* One of three columns */}
            <div className={[styles['message-noti'], ""].join(" ")}>
            ...
            <img src="https://scontent.fixc2-2.fna.fbcdn.net/v/t1.30497-1/143086968_2856368904622192_1959732218791162458_n.png?stp=cp0_dst-png_p60x60&_nc_cat=1&ccb=1-7&_nc_sid=7206a8&_nc_ohc=mvzbp2eS_CYAX9lZDP0&_nc_ht=scontent.fixc2-2.fna&oh=00_AT9EJ5bwVOjR5T-wyjlAlfLehXo0haz6SxEe2L6wukLUWQ&oe=6358D9F8" alt=""/>
            </div>
        </div>
        </div>
    </div>
